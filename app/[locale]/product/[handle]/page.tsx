	...
	return (
		<>
			<script
				...
				// biome-ignore lint/security/noDangerouslySetInnerHtml: Since the data is constructed by us, this should be safe enough.
				...
				<div className="flex flex-col space-y-12">
					...
					<div className="flex flex-col space-y-6 px-6 md:flex-row md:space-x-6 md:space-y-0">
						<div className="md:w-1/2">
							<h1 className="mb-2 font-serif text-[50px] font-bold">
								{product.title}
							</h1>
						</div>
						<div className="md:w-1/2">
