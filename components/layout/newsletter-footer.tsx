...
export default function NewsletterSignup() {
	...
	return (
		<div className="max-w-xl">
			<div className="flex flex-col items-start space-x-0 space-y-0 pb-2 md:flex-row md:items-start md:justify-between md:space-x-6">
				<h3 className="grow font-serif text-2xl tracking-wider">
					{t("newsletter.title")}
				</h3>
				<div className="font-multilingual py-1">
